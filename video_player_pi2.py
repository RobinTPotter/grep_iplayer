            ...
            while done==False:
                ...
                for event in pg.event.get(): # User did something
                    ...
                    if event.type == pg.JOYBUTTONDOWN or ( event.type == pg.KEYDOWN ):
                        ...
                        if 'key' in event.dict:
                            ...
                            if event.key == 273: self.menu_up()
                            elif event.key == 274: self.menu_down()
                            elif event.key == 276: self.menu_left()
                            elif event.key == 275: self.menu_right()
                ...
                if MODE is MAIN:
                    ...
                    for mm in self.movie_list:
                        ...
                        col_select = (255,255,25)
                        if mm == self.current_movie:
                            col = col_select
                            self.current_index = y
                        else: col = col_normal
                        textsurface = font.render(mm, True, (0, 0, 0),col)
